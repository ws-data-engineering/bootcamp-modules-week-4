...
listEl.appendChild(li1).innerHTML = "Chicken Curry";
listEl.appendChild(li2).innerHTML = "Apples"
listEl.appendChild(li3).innerHTML = "Oranges"
listEl.appendChild(li4).innerHTML = "Water"

listEl.setAttribute('style', 'background-color: #333333; padding: 20px;');

li1.setAttribute('style', 'color: white; padding: 5px; margin-left: 35px; background-color: blue;');
li2.setAttribute('style', 'color: white; padding: 5px; margin-left: 35px; background-color: red;');
